...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes=1000, block_name='BasicBlock'):
        ...
        self.inplanes = 16
        self.logpl = LogPoolingCovLayer(9, 9, stride=1, pool_type='avg_pool', num_levels=2, ang_levels=6, facbase=3)
        self.conv1 = nn.Conv2d(3, 16, kernel_size=(4,3), stride=(4,3), padding=0)
        self.centerconv1 = nn.Conv2d(3, 16, kernel_size=1, stride=1, padding=0)
